...
<nav class="hidden {activeSection === "footer" ? "hidden" : "md:flex"} w-full fixed z-50 text-2xl h-18 items-center justify-between md:px-10 lg:px-32 pt-6 pb-2 font-light transitional duration-300  {isDarkSection(activeSection) ? "bg-coal-100 text-white" : "bg-cream-100 text-black"}">
