...
<div class="w-full h-screen font-light flex flex-row justify-between px-32 items-center">
  ...
  <article class="text-3xl text-right [&>span]:highlight">
    ...
    I enjoy working in an agile team<br/>with <span class="highlight">hard-working</span>people.<br/>My<span class="highlight">interests</span>root in videogames, volleyball,<br/>
    diamond paintings and logical puzzles.
  </article>
</div>